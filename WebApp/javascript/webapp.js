 // Variables
            ...
            var mouse = {X:0,Y:0} // Hold mouse pos
            ...
            function cloneblock (obj, event, ui){
                ...
                if (obj){
                    ...
                    block.css({ left: mouse.X+'px', top: mouse.Y+'px'}).attr('id', idn ).removeClass('ui-draggable selected lblock').addClass('block');
                }  
            ...
            $(document).ready(function(){ 
                ...
                // Clone from Lib
                $(function(){
                    $( ".lblock" ).draggable({ opacity: 0.7, revert: true, helper: "clone" });
                });
